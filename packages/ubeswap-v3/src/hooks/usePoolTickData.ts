...
const getActiveTick = (tickCurrent: number | undefined, feeAmount: FeeAmount | undefined) => (tickCurrent && feeAmount ? Math.floor(tickCurrent / 60) * 60 : undefined);

// Fetches all ticks for a given pool
export function useAllV3Ticks(currencyA: Currency | undefined, currencyB: Currency | undefined, feeAmount: FeeAmount | undefined) {
